...
var (
	pattern_Msg_IBCEthereumTx_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 2, 5}, []string{"evmos", "ibc", "evm", "v1", "tx", "ethereum_tx"}, "", runtime.AssumeColonVerbOpt(true)))
)
